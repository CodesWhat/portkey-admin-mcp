...
The current data was pulled from `https://glama.ai/mcp/servers/CodesWhat/portkey-admin-mcp/score.data` (React Router Turbo Stream payload). Add a small script under `scripts/glama-score/` that:
- Fetches that URL
